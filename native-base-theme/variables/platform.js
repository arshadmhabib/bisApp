...
export default {
  ...
  // Segment
  segmentBackgroundColor: (platform === 'ios') ? '#9575CD' : '#9575CD',
  segmentTextColor: (platform === 'ios') ? '#fff' : '#fff',
  segmentActiveBackgroundColor: (platform === 'ios') ? '#fff' : '#fff',
  segmentActiveTextColor: (platform === 'ios') ? '#9575CD' : '#9575CD',
  segmentBorderColor: (platform === 'ios') ? '#fff' : '#fff',
  segmentBorderColorMain: (platform === 'ios') ? '#fff' : '#fff',
